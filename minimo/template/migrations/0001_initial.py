...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TemplateDocumento'
        db.create_table(u'template_templatedocumento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('nome', self.gf('django.db.models.fields.CharField')(unique=True, max_length=70)),
        ...
        db.send_create_signal(u'template', ['TemplateDocumento'])


    def backwards(self, orm):
        # Deleting model 'TemplateDocumento'
        db.delete_table(u'template_templatedocumento')
