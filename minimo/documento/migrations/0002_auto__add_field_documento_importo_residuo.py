...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Documento.importo_residuo'
        db.add_column(u'documento_documento', 'importo_residuo',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Documento.importo_residuo'
        db.delete_column(u'documento_documento', 'importo_residuo')
