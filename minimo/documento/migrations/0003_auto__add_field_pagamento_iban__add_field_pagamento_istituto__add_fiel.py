...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pagamento.iban'
        db.add_column(u'documento_pagamento', 'iban',
                      self.gf('django.db.models.fields.CharField')(max_length=70, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pagamento.istituto'
        db.add_column(u'documento_pagamento', 'istituto',
                      self.gf('django.db.models.fields.CharField')(max_length=70, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pagamento.intestazione'
        db.add_column(u'documento_pagamento', 'intestazione',
                      self.gf('django.db.models.fields.CharField')(max_length=70, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pagamento.iban'
        db.delete_column(u'documento_pagamento', 'iban')

        # Deleting field 'Pagamento.istituto'
        db.delete_column(u'documento_pagamento', 'istituto')

        # Deleting field 'Pagamento.intestazione'
        db.delete_column(u'documento_pagamento', 'intestazione')
