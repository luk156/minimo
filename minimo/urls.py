...
urlpatterns = patterns('',
	...
	#ritenute
	(r'^ritenute/nuovo/$', 'fattura.views.nuovoritenuta'),
	(r'^ritenute/modifica/(?P<i_id>\w+)/$', 'fattura.views.modificaritenuta'),
	(r'^ritenute/elimina/(?P<i_id>\w+)/$', 'fattura.views.eliminaritenuta'),
	# bilancio
