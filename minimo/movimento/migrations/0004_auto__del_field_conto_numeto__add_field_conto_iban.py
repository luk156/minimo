...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Conto.numeto'
        db.delete_column(u'movimento_conto', 'numeto')

        # Adding field 'Conto.iban'
        db.add_column(u'movimento_conto', 'iban',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Conto.numeto'
        raise RuntimeError("Cannot reverse this migration. 'Conto.numeto' and its values cannot be restored.")
        # Deleting field 'Conto.iban'
        db.delete_column(u'movimento_conto', 'iban')
