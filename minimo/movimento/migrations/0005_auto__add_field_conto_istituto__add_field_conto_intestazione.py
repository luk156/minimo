...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conto.istituto'
        db.add_column(u'movimento_conto', 'istituto',
                      self.gf('django.db.models.fields.CharField')(max_length=70, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Conto.intestazione'
        db.add_column(u'movimento_conto', 'intestazione',
                      self.gf('django.db.models.fields.CharField')(max_length=70, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conto.istituto'
        db.delete_column(u'movimento_conto', 'istituto')

        # Deleting field 'Conto.intestazione'
        db.delete_column(u'movimento_conto', 'intestazione')
